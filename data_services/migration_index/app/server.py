...
from .controllers import migration_index
...
def create_app() -> FastAPI:
    ...
    container.wire(modules=[migration_index])
    ...
    app.include_router(migration_index.migration_report_controller)
    return app
...
@app.get("/")
async def welcome():
    return {"message": "Hi! I am migration data service."}
